...
myNormColor = "#ebdbb2" :: String

myFocusColor = "#fbf1c7" :: String
...
myStartupHook :: X ()
myStartupHook = do
    spawnOnce "sh /home/cyber/.xmonad/autostart.sh"
    setWMName "LG3D"
...
myKeys = 
    ...
    -- Keyboard
    ("M-<space>", spawn "$HOME/.xmonad/scripts/chg_layout.sh")
...
main = do
    ...
    xmonad $ ewmh def {
        ...
        logHook = workspaceHistoryHook <+> dynamicLogWithPP xmobarPP {
            ...
            ppCurrent = xmobarColor "#fbf1c7" "#d3869b" . wrap " " "  ", 
            -- Visible but not current workspace
            ppVisible = xmobarColor "#d5c4a1" "",
            -- Hidden workspaces in xmobar
            ppHidden = xmobarColor "#d5c4a1" "",
            -- Hidden workspaces (no windows)
            ppHiddenNoWindows = xmobarColor "#665c54" "",
            -- Title of active window in xmobar
            ppTitle = xmobarColor "#fe8019" "" . shorten 55,
